...
urlpatterns = [
    ...
    path('reportes/planes/', ReportePlanesListView.as_view(), name='reporte_planes'),
    path('reportes/planes/<str:materia>/', ReportePlanesListView.as_view(), name='reporte_planes_filtrado'),
